...
// Using specific SVG paths for icons to avoid extra dependencies if possible, 
// but sticking to standard Lucide pattern via simple wrapper or explicit SVG for XML simplicity.
// For this task, I'll use simple functional components returning SVGs to act like icons.
